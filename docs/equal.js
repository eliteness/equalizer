...
async function sell() {
	...
	notice(`
		...
		<img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> Amount Locked: <u>${fornum(_q[1],18)} ${BASENAME}</u><br>
		...
		<img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> <u>${fornum(_q[0],18)} ${TOKENNAME}</u><br><br><br><br>
		<h4><u><i>Please Confirm this transaction in your wallet!</i></u></h4>
	`)
	...
	notice(`
		...
		<img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> <u>${fornum(_q[0],18)} ${TOKENNAME}</u><br>
		<br><h4>Selling ve${BASENAME} NFT</h4>
		<img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> <u>veNFT #<b>${_id}</b></u>,<br>Containing <u>${fornum(_q[1],18)} ${BASENAME}</u>,<br>Locked for <u>${Number(_q[2])} weeks</u>.<br><br>
	...
	notice(`
		...
		Bought <img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> <u>${fornum(_q[0],18)} ${TOKENNAME}</u> for <img style='height:20px;position:relative;top:4px' src="https://ftm1337.eliteness.network/icons/equal.png"> <u>veNFT #<b>${_id}</b></u>.
		<br><br>
		<h4><a target="_blank" href="https://ftmscan.com/tx/${_tr.hash}">View on Explorer</a></h4>
	`)
	gubs()
